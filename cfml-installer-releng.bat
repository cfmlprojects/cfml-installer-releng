...
cls
echo.
echo       cfml-installer-releng menu
REM echo       usage: cfml-installer-releng.bat [start|stop|{target}]
echo.
...
echo to stop the server, run this again or run: cfml-installer-releng.bat stop
goto end
::
:stopServer
